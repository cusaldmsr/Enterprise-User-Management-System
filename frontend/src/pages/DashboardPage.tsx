      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <Card>
          ...
          <CardContent className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-emerald-500/8 border border-emerald-500/20 rounded-xl p-3 dark:bg-emerald-500/10">
              ...
              <div key={label}>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-bold text-foreground">
                    {value}
                    <span className="text-xs text-muted-foreground font-normal ml-1">({Math.round(pct)}%)</span>
                  </span>
                </div>
        ...
        <Card>
          ...
          <CardContent className="p-0">
            <ScrollArea className="max-h-52 px-6 pb-4">
              {logs.length === 0 ? (
